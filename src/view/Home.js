...
import ScrollViewHome from './component/ScrollViewHome';
        ...
        return (
         ...
         <View style={{flex:1}}>
            ...
            <View style={styles.mainMenu}>
                        <View style={{height:50, width:'80%', flexDirection:"row", justifyContent:"space-between", alignItems:"flex-start"}}>
            ...
            <View style={styles.buttonBar}>
                <View style={styles.buttonNavbar}>
                    <TouchableOpacity title="Go Home" onPress={() => this.props.navigation.navigate('Home')} >
                        <Image style={styles.imageButton}  source={require('./../../src/assets/icons/HomeOn.png')} />
                    </TouchableOpacity>
                </View>
                ...
                <View style={styles.buttonNavbar}>
                    <TouchableOpacity  title="Go Discovery" onPress={() => this.props.navigation.navigate('Discovery')} >
                        ...
                        <Image style={styles.imageButton} source={require('./../../src/assets/icons/Discover.png')} />
